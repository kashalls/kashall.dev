...
if (import.meta.client) {
  watchEffect(() => document.documentElement.classList.toggle('reduce-motion', reduced.value))
}
</script>
...
.background {
  &::after {
    ...
    height: 100vw;
    width: 200vw;
    background: radial-gradient(rgb(var(--color-primary-700)), rgb(var(--color-primary-600) / 0) 70%);
