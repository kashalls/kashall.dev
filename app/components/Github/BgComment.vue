<template>
  <svg class="pointer-events-none absolute inset-0 h-full w-full" preserveAspectRatio="xMidYMin slice" viewBox="0 0 398 263"
      ...
      >
        <g filter="url(#cm_a)">
          <g clip-path="url(#cm_b)">
            ...
            <g clip-path="url(#cm_d)">
              <g clip-path="url(#cm_e)">
                <rect
                  width="144"
                  height="37"
                  x="256"
