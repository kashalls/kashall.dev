// Credit to eggsy.
// https://github.com/eggsy/website/blob/main/src/plugins/Utils/prepareMeta.ts
 ...
 */
export default function prepareMeta ({ title, description, url, image, keywords }, rest) {
  const meta = []
  ...
  if (keywords) {
    meta.push({
      name: 'keywords',
      content: `${typeof keywords === 'object' ? keywords.join(',') : keywords
